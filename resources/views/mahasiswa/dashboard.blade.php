                ...
                <x-table :data="$kps" :filterFields="'[\'metadata.judul\',\'mahasiswa.name\', \'metadata.status\', \'mahasiswa.nomor_induk\']'">
                    ...
                    <x-slot name="header">
                        <tr>
                            ...
                            <th scope="col" class="px-0 py-3 text-center text-xs font-medium text-gray-500 uppercase dark:text-gray-400 w-fit">Tanggal Disetujui</th>
                        </tr>
                    </x-slot>
                    ...
                    <x-slot name="body">
                        ...
                        <template x-for="(kp, index) in paginatedData" :key="index">
                            <tr class="even:bg-gray-100 odd:bg-white hover:bg-gray-100 dark:even:bg-gray-700 dark:odd:bg-gray-800 dark:hover:bg-gray-700">
                                ...
                                <td x-text="kp.approvalDate" class="px-1 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200"></td>
