                        ...
                        <div class="bg-white dark:text-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg px-4 py-4 h-full">
                            ...
                            {{-- <div class="relative mb-3">
                                <select data-hs-select='{
                                        ...
                                        "dropdownClasses": "mt-2 z-50 w-full max-h-60 p-1 space-y-0.5 bg-white border border-gray-200 rounded-lg overflow-hidden overflow-y-auto dark:bg-slate-900 dark:border-gray-700",
