...
return new class extends Migration
{
    ...
    {
        Schema::create('penilalaian_pengujis', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::table('penilaian_pengujis', function (Blueprint $table) {
            $table->dropForeign(['penilaian_id']);
        });
        Schema::dropIfExists('penilalaian_pengujis');
    }
};
